...
// echo $sql;
    ...
    // // show để test
    // // echo ($sql);
    // echo '<pre>'; print_r($diem); echo '</pre>';
    // echo '<pre>'; echo ($hoten_hs); echo '</pre>';
    // echo '<pre>'; echo ($diem1); echo '</pre>';
...
if (is_submit('edit_diem'))
{
    ...
    {       
        ...
        if (db_update('hs_diem', $data, $where)){
            // test $sql
            // $sqlreturn = db_update('hs_diem', $data, $where);
        ...
        <tr>
            ...
            <td>
                <select readonly name="gioitinh">
                    ...
                    <option selected value="1" <?php if($show) {echo ($gioitinh == 1) ? 'selected' : ''; }?>>Nam</option>
                    <option value="2" <?php if($show) {echo ($gioitinh == 2) ? 'selected' : ''; }?>>Nữ</option>
                </select>
